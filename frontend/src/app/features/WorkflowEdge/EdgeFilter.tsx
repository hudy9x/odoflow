...
export default function EdgeFilter({ edgeId }: { edgeId: string }) {
    ...
    const saveFilter = () => {
      onHide();
      console.log('save filter', edgeId, conditions);
    };
    ...
    <div style={{ pointerEvents: 'all' }}>
      <Popover open={visible} onOpenChange={onSetVisible}>
        ...
        <PopoverContent side="right" className="w-[400px] rounded-xl bg-gray-100/40 backdrop-blur-lg p-1 border border-gray-200">
          <div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-4">
                  {conditions.map((orGroup, orIndex) => (
                    <div key={orIndex} className="space-y-4">
                      {orIndex > 0 && (
